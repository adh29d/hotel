...
export default function CoffeeOrder() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        <div className="text-[11px] uppercase tracking-[0.14em] text-muted">Coffee</div>
      ...
      <div>
        <div className="text-[11px] uppercase tracking-[0.14em] text-muted">Pastries</div>
            ...
            return (
              <div key={p.id} className="flex items-center justify-between py-2.5">
                <div>
                  ...
                  <div className="text-[12px] text-muted tabular-nums">{formatMoney(p.price)}</div>
                </div>
                <QuantityStepper
                  size="sm"
                  value={qty}
      ...
      <p className="pt-1 pb-1 text-[11px] text-muted">
        Pickup at reception · in 5 minutes · staff notified on payment
      </p>
    </div>
  );
}
